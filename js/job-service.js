            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-primary job-button" onclick="JobService.get(`+data[i].job_id+`)">Uredi</button>
                  <button type="button" class="btn btn-danger job-button" onclick="JobService.delete(`+data[i].job_id+`)">Obriši</button>
                </div>
              </div>
            </div>
          </div>
